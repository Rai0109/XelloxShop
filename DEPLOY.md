...
| `SMTP_PORT` | `587` hoặc `465` (nếu 587 fail) | ⭐ |
| `SHOP_NAME` | Tên shop | ✅ |
| `CLOUDINARY_URL` | URL từ Cloudinary | ⭐ Khuyên dùng |
| `MB_USERNAME` | Tài khoản MBBank | ❌ Tuỳ chọn |
| `MB_PASSWORD` | Mật khẩu MBBank | ❌ Tuỳ chọn |

> **🚨 Gmail App Password cho Railway:**  
> 1. [myaccount.google.com/apppasswords](https://myaccount.google.com/apppasswords)  
> 2. App: `Mail` | Device: `XelloxShop-Railway`  
> 3. Copy **16 ký tự** (không space) → paste vào `SMTP_PASS`  
> 4. Test: `POST /api/test-smtp {\"to_email\":\"test@gmail.com\"}`  
> 
> **Port issues:** Nếu 587 fail (Railway block), set `SMTP_PORT=465`
